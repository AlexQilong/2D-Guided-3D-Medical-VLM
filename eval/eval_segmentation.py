...
from lamed.dataset.multi_dataset import SegDataset
from eval.metrics import BinaryDice
...
def parse_args(args=None):
    ...
    # parser.add_argument('--model_name_or_path', type=str, default="LaMed/pretrained_model/models--GoodBaiBai88--M3D-LaMed-Phi-3-4B/snapshots/329bed510c2cff0ad3fe6f2a1a7075f45e2706e9", choices=[])
    parser.add_argument('--model_name_or_path', type=str, default="LaMed/output/LaMed-Phi3-4B-merge-0000", choices=[])
    parser.add_argument('--output_dir', type=str, default="./LaMed/output/LaMed-finetune-0000/eval_seg_m1/")
